...
export default function CarTable({ cars, onEdit }: Props) {
              ...
              <tr key={car.id} className="border-t border-border">
                <td className="px-5 py-4">
                  <div className="flex items-center gap-4">
                    <div className="relative h-14 w-20 overflow-hidden rounded-lg shrink-0">
                      <Image
                        src={car.image_url}
                        alt={car.name}
                        fill
                ...
                <td className="px-5 py-4">{car.category}</td>
                <td className="px-5 py-4">
          ...
          <div key={car.id} className="p-4">
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-sm text-muted">{car.brand}</p>
                <p className="text-sm text-muted">{car.category}</p>
              </div>
            </div>
            ...
            <div className="mt-3 flex gap-2">
              <button
                onClick={() => onEdit(car)}
                className="flex flex-1 items-center justify-center gap-2 rounded-lg border py-2 hover:bg-gray-100"
              >
                <Pencil size={16} /> Edit
              </button>
              <button
                onClick={() => handleDelete(car.id)}
                className="flex flex-1 items-center justify-center gap-2 rounded-lg border py-2 text-red-600 hover:bg-red-50"
              >
